...
namespace LockKeyboardCsharp
{
    internal static class Win32
    {
        ...
        public const short SHELL_CODE_DWORDLEN = 318;//注入代码所占的双字数
        public const short SHELL_CODE_LENGTH = (SHELL_CODE_DWORDLEN * 4);// '字节数
        public const short SHELL_FUNCOFFSET = 0x8;// '注入代码线程函数偏移量
        ...
        public static extern bool WriteProcessMemory(IntPtr hProcess,
            IntPtr lpBaseAddress, uint[] lpBuffer, uint nSize,
        ...
        [DllImport("kernel32.dll", SetLastError = true, CharSet = CharSet.Auto, EntryPoint = "GlobalFindAtomW")]
        ...
        public static extern IntPtr CreateRemoteThread(IntPtr hProcess,
           IntPtr lpThreadAttributes, uint dwStackSize, int
           lpStartAddress, IntPtr lpParameter, uint dwCreationFlags, out IntPtr lpThreadId);
        [DllImport("kernel32.dll", SetLastError = true)]
        ...
        public static extern void MoveMemory(object dest, IntPtr src, int size);
